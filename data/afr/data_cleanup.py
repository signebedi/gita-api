...
authors_df = pd.read_json('data/afr/authors.json')
...
english_df = english_df.loc[english_df['Commentary'] == "Afr"]
...
# Add book id
english_df['book_id'] = '5'

df_concatenated = pd.concat([df, english_df], ignore_index=True)

df_concatenated.to_json('data/afr/cleaned_data.json')
