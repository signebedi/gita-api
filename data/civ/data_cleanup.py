...
authors_df = pd.read_json('data/civ/authors.json')
...
english_df = english_df.loc[english_df['Commentary'] == "BC"]
...
# Add book id
english_df['book_id'] = '3'

df_concatenated = pd.concat([df, english_df], ignore_index=True)

df_concatenated.to_json('data/civ/cleaned_data.json')
