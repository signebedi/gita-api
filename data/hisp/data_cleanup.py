...
authors_df = pd.read_json('data/hisp/authors.json')
...
english_df = english_df.loc[english_df['Commentary'] == "Hisp"]
...
# Add book id
english_df['book_id'] = '6'

df_concatenated = pd.concat([df, english_df], ignore_index=True)

df_concatenated.to_json('data/hisp/cleaned_data.json')
